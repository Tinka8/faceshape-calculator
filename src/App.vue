    ...
    <div class="container p-6 w-1/4 m-12 mx-auto bg-blue-200 shadow-lg rounded space-y-2">
      <div class="text-gray-700">
        <ul class="space-y-2">
          ...
          <li class="py-2">
            <div v-show="gender === ''">
              <img src="https://uploads-cdn.omnicalculator.com/images/face-shape/measure/Measure.png" width="500"
                height="250" />
            </div>
            <div v-if="gender === 'male'">
              <img src="https://uploads-cdn.omnicalculator.com/images/face-shape/measure/MeasureM.png" width="500"
                height="200" />
            </div>
            <div v-else-if="gender === 'female'">
              <img src="https://uploads-cdn.omnicalculator.com/images/face-shape/measure/MeasureF.png" width="500"
                height="200" />
            </div>
          </li>
